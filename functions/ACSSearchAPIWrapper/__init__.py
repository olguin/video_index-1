...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        logging.info(f'Python HTTP trigger function processed a request params{parameters}.')
        response = json.dumps(search_from_json(parameters))
