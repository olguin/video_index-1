...
def test_get_metadata_values(fake_config_file, fake_work_order):
        ...
        assert "https://doubletime.crm.dynamics.com/main.aspx?cmdbar=false&navBar=off&newWindow=true&pagetype=entityrecord&etn=msdyn_workorder&id=be343d0c-60c9-43e6-a1ba-9ea03a0a34ea" == metadata_values['Work_Order_URL'] 
